...
// register valazi_Popular_Post widget
function valazi_register_popular_post_widget() {
    register_widget( 'valazi_Popular_Post' );
}
add_action( 'widgets_init', 'valazi_register_popular_post_widget' );
 
 /**
 * Adds valazi_Popular_Post widget.
 */
class valazi_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'valazi_popular_post', // Base ID
			esc_html__( 'Valazi: Popular Post', 'valazi' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'valazi' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? strip_tags( $instance['title'] ) : esc_html__( 'Popular Posts', 'valazi' );
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? sanitize_text_field( $new_instance['title'] ) : esc_html__( 'Popular Posts', 'valazi' );
