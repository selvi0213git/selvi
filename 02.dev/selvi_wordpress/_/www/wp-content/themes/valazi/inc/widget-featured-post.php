...
// register valazi_Featured_Post widget
function valazi_register_featured_post_widget() {
    register_widget( 'valazi_Featured_Post' );
}
add_action( 'widgets_init', 'valazi_register_featured_post_widget' );
 
 /**
 * Adds valazi_Featured_Post widget.
 */
class valazi_Featured_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'valazi_featured_post', // Base ID
			__( 'Valazi: Featured Post', 'valazi' ), // Name
			array( 'description' => __( 'A Featured Post Widget', 'valazi' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        $read_more      = !empty( $instance['readmore'] ) ? $instance['readmore'] : __( 'Read More', 'valazi' );		     
            ...
            ?>
                ...
                <div class="img-holder">
                    <a href="<?php the_permalink(); ?>">
                        <?php the_post_thumbnail( 'valazi-featured-post' ); ?>
                    </a>
                </div>    				
                <?php } ?>
	...
	public function form( $instance ) {
        ...
        ?>
		<p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'post_list' ) ); ?>"><?php esc_html_e( 'Posts', 'valazi' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'readmore' ) ); ?>"><?php esc_html_e( 'Read More Text', 'valazi' ); ?></label> 
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['readmore']       = ! empty( $new_instance['readmore'] ) ? sanitize_text_field( $new_instance['readmore'] ) : __( 'Read More', 'valazi' );
