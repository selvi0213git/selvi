...
class event_delivery {
								...
								<div class="field-agree">
										<p class="check-form">
											...
											<label for="agree_individual">
												<a onclick="popupFunc('http://selvi.co.kr/agree_individual.html',400,600,'개인정보동의')">
													개인정보동의
												</a>
											</label>
										</p>
										<p class="check-form">
											...
											<label for="agree_service">
												<a onclick="popupFunc('http://selvi.co.kr/agree_service.html',400,600,'서비스이용약관동의')">
													서비스이용약관동의
												</a>
											</label>
										</p>
	...
	if( ! isset($_REQUEST['eventdelivery_nonce'])
		...
		//wp_redirect("http://selvi.co.kr/mypage?enter_id=".$enter_id."#list" );
