	...
	<!-- detail renewal start -------------------------------------------------------------------------->
		...
		//사용자시작
			...
			*/
				...
				var user_id  = <?php echo $user_id?>;
					...
					if(!user_id){
						...
						//if(confirm("로그인이 필요한 서비스입니다.\n로그인하시겠습니까?")){
							//location.href = "http://selvi.co.kr/selvi_login/";
						...
						*/
						...
						//페이스북 자동로그인 20170714
						location.href = 'http://selvi.co.kr/?action=cosmosfarm_members_social_login&channel=facebook&redirect_to=<?php echo get_permalink()?>';
			...
			/*	var user_id  = <?php echo $user_id?>;
					...
					if(!user_id){
						//네이버 자동로그인 20170914
						location.href = 'http://selvi.co.kr/?action=cosmosfarm_members_social_login&channel=naver&redirect_to=<?php echo get_permalink()?>';
		...
		*/	
		...
		/*		var user_id  = <?php echo $user_id?>;
					...
					if(!user_id){
						//카카오 자동로그인 20170914
						location.href = 'http://selvi.co.kr/?action=cosmosfarm_members_social_login&channel=kakao&redirect_to=<?php echo get_permalink()?>';
