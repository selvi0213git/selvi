...
<html <?php language_attributes(); ?>>
	<head>
		...
		fbq('init', '1599532676753919'); // Insert your pixel ID here.
		fbq('track', 'PageView');
		</script>
		<noscript><img height="1" width="1" style="display:none"
		src="https://www.facebook.com/tr?id=1599532676753919&ev=PageView&noscript=1"
		/></noscript>
		<!-- DO NOT MODIFY -->
	...
	<!-- head renewal start -------------------------------------------------------------------------->
		...
		<link rel='stylesheet' id='custom-styling-css' href='http://selvi.co.kr/wp-content/themes/proton-child/assets/css/custom-style.css?ver=4.7.5' type='text/css' media='all' />
	...
	<!-- body renwal start -------------------------------------------------------------------------->
			...
			<!-- yeonok: 로그인버튼 삭제 -->
			<!-- <div align="right" class="container" style="color: #999999;"><a href="http://selvi.co.kr/login/"> LOGIN </a></div> -->
			<div class="container">
				<div class="default-header <?php echo esc_attr($proton_header_layout_column); ?>">
					<div class="logo">
						<a href="http://selvi.co.kr">
							<!-- yeonok: 로고 이미지 교체 -->
					...
					<div class="header-holder">
						...
						<?php 
							...
							if ($user_id == 0) {
								// yeonok: 로그인버튼 추가 
								//<a href="http://selvi.co.kr/login/" class="btn-login">로그인</a>
								echo '<a href="http://selvi.co.kr/login/" class="btn-login">로그인</a>';
								...
								<div class="member-info">
									...
									<ul class="member-menu">
										...
										<?php if ($current_user->user_status == 1){ ?>
											...
											<li><a href="http://selvi.co.kr/logout/">로그아웃</a></li>
										
										<!-- Customer -->
										<?php } else { ?>
										
											<li><a href="http://selvi.co.kr/mypage/">마이페이지</a></li>
											<li><a href="http://selvi.co.kr/logout/">로그아웃</a></li>
