			...
			<div class="container">
				...
				<div class="footer-widgets">
					...
					<div class="footer-menu">
						<a href="http://selvi.co.kr/about/">회사소개</a>
						<span class="divider">ㆍ</span>
						<a href="javascript:popupFunc('http://selvi.co.kr/agree_service.html',400,600,'서비스이용약관동의')">이용약관</a>
						<span class="divider">ㆍ</span>
						<a href="javascript:popupFunc('http://selvi.co.kr/agree_individual.html',400,600,'개인정보보호방침')">개인정보보호방침</a>
						<span class="divider">ㆍ</span>
						<a href="http://selvi.co.kr/contact/">협력/제휴</a>
					</div><!-- /.footer-menu -->
